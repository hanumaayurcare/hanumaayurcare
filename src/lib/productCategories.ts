...
export const dosageForms: Category[] = [
  ...
  { name: "Churna", slug: "churna", desc: "Powdered herb mixtures", icon: Leaf },
  { name: "Kwath", slug: "kwath", desc: "Herbal decoctions", icon: Coffee },
  { name: "Guggulu", slug: "guggulu", desc: "Resin-based formulations", icon: Flower2 },
  { name: "Vati & Gutika", slug: "vati-gutika", desc: "Tablets and pills", icon: Pill },
  { name: "Bhasma", slug: "bhasma", desc: "Calcined mineral preparations", icon: Flame },
  { name: "Taila", slug: "taila", desc: "Medicated oils", icon: Droplet },
  { name: "Ghrita", slug: "ghrita", desc: "Medicated ghee preparations", icon: Utensils },
  { name: "Lepa", slug: "lepa", desc: "Pastes for external application", icon: Sparkles },
  { name: "Avaleha", slug: "avaleha", desc: "Semi-solid jams", icon: Cookie }
];
